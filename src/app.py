...
def _register_blueprints(app: Flask) -> None:
    ...
    import routes.main     as _routes_main
    import routes.tasks    as _routes_tasks
    import routes.extras   as _routes_extras
    import routes.updates  as _routes_updates
    import routes.hardware as _routes_hardware
    import routes.system   as _routes_system
